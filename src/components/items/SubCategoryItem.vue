<template>
  <div class="subcat-item">
    <input type="radio" name="category" :id="'subcategory_'+item.id" :value="item.id" class="subcat-item-input" v-model.number="modelValue">
    <label :for="'subcategory_'+item.id" :style="bgImg" class="subcat-item-label">
      <div class="flex aic jcc wfull p2">
        <svg class="ic70 icwhite"><use :xlink:href="icon"></use></svg>
      </div>
      <div class="subcat-item-label-desc">
